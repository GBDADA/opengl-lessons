...
int main(int argc, char *argv[]) {
    ...
    window = createWindow("Terrain", SCREEN_WIDTH, SCREEN_HEIGHT);
    if (window == nullptr) {
    ...
    terrain = new Terrain((texturePath + "data/heightMap.png").c_str(), (texturePath + "data/terrain.png").c_str(), 100, 15);
